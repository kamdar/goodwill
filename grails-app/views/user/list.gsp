			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="lastLoggedin" title="${message(code: 'user.lastLoggedin.label', default: 'Last Loggedin')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${userInstance.lastLoggedin}" /></td>
